...
def plot_unit_circle(alpha):
    ...
    plt.plot([0, 0], [0, y], 'o-', linewidth=3, markersize=0, color=custom_palette[2], label='cos')
    plt.plot([0, 0], [0, y], 'o-', linewidth=3, markersize=0, color=custom_palette[2], label='sin')
